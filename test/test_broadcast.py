...
class TestBroadcast(unittest.TestCase):
  ...
  def test_broadcasted_mul1(self):
    ...
    t3 = t1*t2
    t3.realize()
    self.assertEqual([0.0,1.0,0.0,3.0,0.0,5.0,0.0,7.0,0.0,9.0], t3.data().flatten()[0:10].tolist())
  ...
  def test_broadcasted_add(self):
    ...
    t3 = t1+t2
    t3.realize()
    self.assertEqual([0.0, 2.0, 2.0, 4.0, 4.0, 6.0, 6.0, 8.0, 8.0, 10.0], t3.data().flatten()[0:10].tolist())
