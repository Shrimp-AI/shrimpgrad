...
class TestThunk(unittest.TestCase):
  ...
  def test_load_const_reshape(self):
    ...
    self.assertEqual(src.realized,None)
...
class TestLoads(unittest.TestCase):
  def test_load_const_function_nd(self):
    ...
    self.assertEqual(LoadOps.CONST, t._op)
    self.assertEqual((), t._operands)
    self.assertEqual((2,2,2), t.shape)
    self.assertEqual(3.0,t.arg )
    self.assertEqual(8*4, t.buff.nbytes)
    self.assertEqual(False, t.buff.allocated)
  ...
  def test_load_const_function_scalar(self):
    ...
    self.assertEqual(3.0,t.arg )
    self.assertEqual(4, t.buff.nbytes)
    self.assertEqual(False, t.buff.allocated)
    self.assertEqual(ClangDevice(), t.device)
  ...
  def test_load_const(self):
    ...
    self.assertEqual(LoadOps.CONST, x.thunk._op)
    self.assertEqual(3.0, x.thunk.arg)
